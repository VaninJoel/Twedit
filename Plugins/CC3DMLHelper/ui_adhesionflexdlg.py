...
class Ui_AdhesionFlexDlg(object):
    def setupUi(self, AdhesionFlexDlg):
        ...
        AdhesionFlexDlg.setWindowTitle(QtWidgets.QApplication.translate("AdhesionFlexDlg", "Please define adhesion molecules", None, QtWidgets.QApplication.UnicodeUTF8))
        ...
        item.setText(QtWidgets.QApplication.translate("AdhesionFlexDlg", "Adhesion Molecule", None, QtWidgets.QApplication.UnicodeUTF8))
        ...
        self.label_9.setText(QtWidgets.QApplication.translate("AdhesionFlexDlg", "Molecule", None, QtWidgets.QApplication.UnicodeUTF8))
        self.label_9.setObjectName(_fromUtf8("label_9"))
        self.horizontalLayout.addWidget(self.label_9)
        self.afMoleculeLE = QtGui.QLineEdit(AdhesionFlexDlg)
        self.afMoleculeLE.setToolTip(QtWidgets.QApplication.translate("AdhesionFlexDlg", "Specify names of the adhesion molecules you want to use int he simulation", None, QtWidgets.QApplication.UnicodeUTF8))
        ...
        self.afMoleculeAddPB.setText(QtWidgets.QApplication.translate("AdhesionFlexDlg", "Add", None, QtWidgets.QApplication.UnicodeUTF8))
        ...
        self.label_10.setText(QtWidgets.QApplication.translate("AdhesionFlexDlg", "Binding Formula", None, QtWidgets.QApplication.UnicodeUTF8))
        self.label_10.setObjectName(_fromUtf8("label_10"))
        self.horizontalLayout_2.addWidget(self.label_10)
        self.bindingFormulaLE = QtGui.QLineEdit(AdhesionFlexDlg)
        self.bindingFormulaLE.setToolTip(QtWidgets.QApplication.translate("AdhesionFlexDlg", "This is binary function that takes atwo arguments -  Molecule1 and Molecule2. The allowed functions are those given by muParser - see http://muparser.sourceforge.net/", None, QtWidgets.QApplication.UnicodeUTF8))
        self.bindingFormulaLE.setText(QtWidgets.QApplication.translate("AdhesionFlexDlg", "min(Molecule1,Molecule2)", None, QtWidgets.QApplication.UnicodeUTF8))
        ...
        self.clearAFTablePB.setText(QtWidgets.QApplication.translate("AdhesionFlexDlg", "Clear Table", None, QtWidgets.QApplication.UnicodeUTF8))
        ...
        self.okPB.setText(QtWidgets.QApplication.translate("AdhesionFlexDlg", "OK", None, QtWidgets.QApplication.UnicodeUTF8))
        ...
        self.cancelPB.setText(QtWidgets.QApplication.translate("AdhesionFlexDlg", "Cancel", None, QtWidgets.QApplication.UnicodeUTF8))
