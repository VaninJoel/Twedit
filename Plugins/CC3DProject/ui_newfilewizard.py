...
class Ui_NewFileWizard(object):
    ...
    def retranslateUi(self, NewFileWizard):
        NewFileWizard.setWindowTitle(QtWidgets.QApplication.translate("NewFileWizard", "Add New File (Resource) to CC3D Simulation", None, QtWidgets.QApplication.UnicodeUTF8))
        self.label_2.setText(QtWidgets.QApplication.translate("NewFileWizard", "Name:", None, QtWidgets.QApplication.UnicodeUTF8))
        self.nameBrowsePB.setText(QtWidgets.QApplication.translate("NewFileWizard", "Browse...", None, QtWidgets.QApplication.UnicodeUTF8))
        self.label.setText(QtWidgets.QApplication.translate("NewFileWizard", "File Type:", None, QtWidgets.QApplication.UnicodeUTF8))
        self.fileTypeCB.setItemText(0, QtWidgets.QApplication.translate("NewFileWizard", "Main Python Script", None, QtWidgets.QApplication.UnicodeUTF8))
        self.fileTypeCB.setItemText(1, QtWidgets.QApplication.translate("NewFileWizard", "XML Script", None, QtWidgets.QApplication.UnicodeUTF8))
        self.fileTypeCB.setItemText(2, QtWidgets.QApplication.translate("NewFileWizard", "Python File", None, QtWidgets.QApplication.UnicodeUTF8))
        self.fileTypeCB.setItemText(3, QtWidgets.QApplication.translate("NewFileWizard", "PIF File", None, QtWidgets.QApplication.UnicodeUTF8))
        self.fileTypeCB.setItemText(4, QtWidgets.QApplication.translate("NewFileWizard", "Concentration File", None, QtWidgets.QApplication.UnicodeUTF8))
        self.label_4.setText(QtWidgets.QApplication.translate("NewFileWizard", " Location:", None, QtWidgets.QApplication.UnicodeUTF8))
        self.locationBrowsePB.setText(QtWidgets.QApplication.translate("NewFileWizard", "Browse...", None, QtWidgets.QApplication.UnicodeUTF8))
        self.label_3.setText(QtWidgets.QApplication.translate("NewFileWizard", "Project Directory", None, QtWidgets.QApplication.UnicodeUTF8))
        self.customTypeCHB.setText(QtWidgets.QApplication.translate("NewFileWizard", " Custom File Type ", None, QtWidgets.QApplication.UnicodeUTF8))
