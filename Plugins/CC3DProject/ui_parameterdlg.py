...
class Ui_ParameterDlg(object):
    def setupUi(self, ParameterDlg):
        ...
        ParameterDlg.setWindowTitle(QtWidgets.QApplication.translate("ParameterDlg", "Scannable Paramerters", None, QtWidgets.QApplication.UnicodeUTF8))
        ...
        self.elementLB.setText(QtWidgets.QApplication.translate("ParameterDlg", "Element:", None, QtWidgets.QApplication.UnicodeUTF8))
        ...
        item.setText(QtWidgets.QApplication.translate("ParameterDlg", "Parameter", None, QtWidgets.QApplication.UnicodeUTF8))
        self.paramTW.setHorizontalHeaderItem(0, item)
        item = QtGui.QTableWidgetItem()
        item.setText(QtWidgets.QApplication.translate("ParameterDlg", "Type", None, QtWidgets.QApplication.UnicodeUTF8))
        self.paramTW.setHorizontalHeaderItem(1, item)
        item = QtGui.QTableWidgetItem()
        item.setText(QtWidgets.QApplication.translate("ParameterDlg", "Value", None, QtWidgets.QApplication.UnicodeUTF8))
        self.paramTW.setHorizontalHeaderItem(2, item)
        item = QtGui.QTableWidgetItem()
        item.setText(QtWidgets.QApplication.translate("ParameterDlg", "Action", None, QtWidgets.QApplication.UnicodeUTF8))
        ...
        self.pushButton.setText(QtWidgets.QApplication.translate("ParameterDlg", "Cancel", None, QtWidgets.QApplication.UnicodeUTF8))
        self.pushButton.setObjectName(_fromUtf8("pushButton"))
        self.horizontalLayout.addWidget(self.pushButton)
        self.okPB = QtGui.QPushButton(ParameterDlg)
        self.okPB.setText(QtWidgets.QApplication.translate("ParameterDlg", "OK", None, QtWidgets.QApplication.UnicodeUTF8))
