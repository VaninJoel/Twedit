...
class CC3DCPPHelper(QObject):
    ...
    def __initActions(self):
        ...
        snippetFilePath=os.path.abspath(os.path.join(os.path.dirname(__file__),'CC3DCPPHelper/Snippets.cpp.template'))
    ...
    def generateNewModule(self):        
        ...
        if os.path.exists(fullModuleDir):
            ...
            try:
                ...
                QtWidgets.QMessageBox.information(self.__ui, "Could not create directory",message,QtWidgets.QMessageBox.Ok)
                return
    ...
    def addModuleToModuleDirCMakeFile(self,_moduleName,_moduleDir):
        ...
        try:
            ...
            QtWidgets.QMessageBox.information(self.__ui, "Could not write to file",message,QtWidgets.QMessageBox.Ok)
            return
    ...
    def modifySwigFilesDeveloperZone(self,_features):
        ...
        if fileLocalizationError:
            ...
            QtWidgets.QMessageBox.information(self.__ui, "Problem with SWIG files",message,QtWidgets.QMessageBox.Ok)        
            return
