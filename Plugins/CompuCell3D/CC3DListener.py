...
class CC3DListener(QTcpServer):    
    ...
    def __init__(self, parent=None):
        ...
        if self.port >0 and not self.listen(QHostAddress("127.0.0.1"),self.port):
            ...
            QtWidgets.QMessageBox.critical(None, "FileNameReceiver",
    ...
    def maybeCloseEditor(self):
        ...
        ret=QtWidgets.QMessageBox.information(self.editorWindow, "CompuCell3D has been closed","Close editor as well? ",QMessageBox.Yes|QMessageBox.No)
    ...
    def startServer(self):
        ...
        if self.port >0 and not self.listen(QHostAddress("127.0.0.1"),self.port):
            ...
            ret=QtWidgets.QMessageBox.critical(None, "FileNameReceiver",
